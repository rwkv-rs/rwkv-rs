...
impl IpcOpenAiClient {
    ...
    pub fn health(&self) -> crate::Result<crate::access::http_api::HealthResponse> {
        let responses = self.send_request(RouteId::Health, false, Vec::new())?;
        parse_single_data(responses, "health response")
    }

    pub fn models(&self) -> crate::Result<crate::access::http_api::ModelListResponse> {
    ...
    pub fn completions(
        &self,
        mut request: crate::access::http_api::CompletionRequest,
    ) -> crate::Result<crate::access::http_api::CompletionResponse> {
    ...
    pub fn completions_stream(
        &self,
        mut request: crate::access::http_api::CompletionRequest,
    ) -> crate::Result<Vec<crate::access::http_api::CompletionResponse>> {
    ...
    pub fn chat_completions(
        &self,
        mut request: crate::access::http_api::ChatCompletionRequest,
    ) -> crate::Result<crate::access::http_api::ChatCompletionResponse> {
        request.stream = Some(false);
        let payload = encode_json(&request)?;
    ...
    pub fn chat_completions_stream(
        &self,
        mut request: crate::access::http_api::ChatCompletionRequest,
    ) -> crate::Result<Vec<crate::access::http_api::ChatCompletionChunkResponse>> {
        request.stream = Some(true);
        let payload = encode_json(&request)?;
    ...
    pub fn responses_create(
        &self,
        request: crate::access::http_api::ResponsesCreateRequest,
    ) -> crate::Result<crate::access::http_api::ResponsesResource> {
        let responses =
    ...
    pub fn responses_get(
        &self,
        request: crate::access::http_api::ResponseIdRequest,
    ) -> crate::Result<crate::access::http_api::ResponsesResource> {
    ...
    pub fn admin_models_reload(
        &self,
        request: crate::access::http_api::ReloadModelsRequest,
    ) -> crate::Result<crate::access::http_api::ReloadModelsResponse> {
        let responses =
...
fn frame_to_error(frame: IpcResponse) -> crate::Error {
    match decode_json::<crate::access::http_api::OpenAiErrorResponse>(&frame.payload, "error frame")
    {
        Ok(err) => {

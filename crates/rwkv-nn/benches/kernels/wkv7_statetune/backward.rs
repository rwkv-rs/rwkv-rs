...
fn bench_wkv7_statetune_backward(c: &mut Criterion) {
    let mut group = c.benchmark_group("rwkv-nn/kernels/wkv7_statetune/backward");
...
fn main() {
    ...
    bench_wkv7_statetune_backward(&mut criterion);

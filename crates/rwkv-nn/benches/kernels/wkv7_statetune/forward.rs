...
fn bench_wkv7_statetune_forward(c: &mut Criterion) {
    let mut group = c.benchmark_group("rwkv-nn/kernels/wkv7_statetune/forward");
...
fn main() {
    ...
    bench_wkv7_statetune_forward(&mut criterion);

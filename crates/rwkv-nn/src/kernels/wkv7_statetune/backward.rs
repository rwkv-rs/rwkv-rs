...
impl<B: Wkv7StateTuneBackend, C: CheckpointStrategy> Wkv7StateTuneBackend for Autodiff<B, C> {
    fn wkv7_statetune_forward(
        ...
        impl<B: Wkv7StateTuneBackend> Backward<B, 7> for Wkv7Backward {
            type State = (
                NodeId,
                NodeId,
                NodeId,
            ...
            fn backward(
                ...
                let grads_out = B::wkv7_statetune_backward(
                    weight_decay,
                    receptance,
                    key,
                    value,
...
impl<B: Wkv7StateTuneBackend, C: CheckpointStrategy> Wkv7StateTuneAutodiffBackend
    for Autodiff<B, C>
{
}

...
pub struct MultiCausalCellsIO<B: Backend> {
    ...
    pub elapsed_t: Option<Tensor<B, 1, Int>>, // [full_batch_size]
...
impl<B: AddcmulBackend + TokenShiftDiffBackend> CausalCell<B> {
    ...
    pub fn forward<K: Wkv7Kernel<B>>(
        ...
        let time_mixer_input = TimeMixerIO {
            ...
            batch_ids: batch_ids.clone(),
            elapsed_t: causal_cell_input.elapsed_t.clone(),
        ...
        CausalCellIO {
            embedded_context,
            batch_ids,
            elapsed_t: causal_cell_input.elapsed_t,

...
use super::{
    admin::{
        admin_eval_cancel, admin_eval_pause, admin_eval_resume, admin_eval_start,
        admin_eval_status, admin_health,
    },
...
mod tests {
    ...
    fn test_app_state(admin_api_key: Option<&str>) -> AppState {
        ...
        let service_config = RawEvalConfig {
            ...
            run_mode: None,
            continue_on_benchmark_error: None,
            skip_checker: None,
            attempt_concurrency: None,

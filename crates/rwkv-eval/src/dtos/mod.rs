...
use crate::{
    cores::datasets::{CoTMode, Field},
    db::{CompletionStatus, TaskStatus},
};
...
#[derive(Debug, Serialize, ToSchema)]
pub struct AdminEvalStatusResponse {
    pub status: String,
...
#[derive(Debug, Serialize, ToSchema)]
pub struct AdminHealthTargetResource {
    pub base_url: String,

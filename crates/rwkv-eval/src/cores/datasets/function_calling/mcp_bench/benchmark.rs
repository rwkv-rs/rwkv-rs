...
use crate::cores::inferers::generate_text_completion;
...
mod tests {
    ...
    use crate::cores::datasets::function_calling::mcp_bench::prompt::build_context_summary;
    use crate::cores::datasets::function_calling::mcp_bench::types::RawTaskFile;

    crate::cores::datasets::benchmark_dataset_tests!(MCP_BENCH_INFO);
